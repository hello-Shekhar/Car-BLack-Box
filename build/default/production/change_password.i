...
void change_password() {
    ...
    if (flag == 1) {
        ...
        clcd_print("ReEnter password", (0x80 + (0)));
        if (11 == key) {
            delay++;
            if (delay > 500) {
                delay = 0;
    ...
    if (flag == 0) {
        ...
        if (worng == 0) {
            ...
            clcd_print("WORNG PASSWORD", (0x80 + (0)));
            _delay((unsigned long)((500)*(20000000/4000.0)));
            shift = 0;
            flag = 1;
            clcd_write(0x01, 0);
