...
void dash_board() {
    short var = read_adc(0x04);
    val = var / 10.24;
    clcd_putch(val % 10 + 48, (0xC0 + (14)));
    clcd_putch((val / 10) % 10 + 48, (0xC0 + (13)));

    clcd_print("  TIME   EVT SPD", (0x80 + (0)));
    int key = read_switches(1);
